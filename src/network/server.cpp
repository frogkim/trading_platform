...
// External functions
void ServerSetup(UINT buf_size, UINT max_iocp_threads, UINT max_server_capacity, UINT default_client_list_size)
{
...
bool ServerRunNode(UINT index)
{
    return 0;
}

bool ServerStopNode(UINT index)
{
    return 0;
}

bool ServerRemoveNode(UINT index)
{
    return 0;
}

bool ServerSend(UINT index, char* buf)
{
    return 0;
}

bool ServerRecv(UINT index, char* buf)
{
    return 0;
}

void ServerSendAsync(UINT index, char* buf)
{
}

void ServerRecvAsync(UINT index, char* buf)
{
}
...
//    m_nodes[index].index = UINT16_MAX;
//    m_nodes[index].socket = NULL;
//    m_capacity--;
//}
//
//// helper function
//UINT32 Server_cl::Find_seat()
//{
...
//}
//
//void Server_cl::Stop_node(UINT32 index)
//{
//    m_nodes[index].stop = true;
//}
//
//void Server_cl::Start_node(UINT32 index)
//{
//    m_nodes[index].stop = false;
//}
//
